                    ...
                    <div class="row" style="background-color: rgba(9,9,9,0.96); border: 3px dashed; border-color: #b40e50; border-bottom-left-radius: 25px; border-top-right-radius: 25px">
                        <div class="col-12">
                            <div class="tab-content">
                               <?php
                               if(isset($_GET['edit_toll_id'])){
                                   $status = $datamanipulation->showTollDataById($_GET['edit_toll_id']);

                                   $id = $_GET['edit_toll_id'];
                               ...
                               ?>
                                <div class="tab-pane active" id="settings">
                                    <form class="form-horizontal" action="../process/staff_process.php" method="post">
                                        <div class="row">
                                            ...
                                            <div class="col-11 ml-3" >
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <input type="text"required class="form-control" value="<?php echo $driver_name?>" name="driver_name" style="border-radius: 25px">
                                                 ...
                                                 <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <input type="number"required class="form-control" value="<?php echo $amount?>" name="amount" style="border-radius: 25px">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <input type="text" required class="form-control" name="vehicle_no" value="<?php echo $vehicle_no?>" style="border-radius: 25px">
                                                    </div>
                                                </div>
                                                ...
                                                <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <input type="text" required class="form-control" name="phone" value="<?php echo $phone?>" style="border-radius: 25px">
                                                    </div>
                                                </div>
                                        ...
                                        <input type="submit" class="btn btn-success btn-rounded w-90  mb-2"  name="edit_toll_pass" value="Edit" style="margin-top: 15px;font-size: 21px; text-align: center;border: 1px solid;" >
