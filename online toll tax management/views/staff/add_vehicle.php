                            ...
                            <div class="tab-content">
                                ...
                                <div class="tab-pane active" id="settings">
                                    <form class="form-horizontal" action="../process/staff_process.php" method="post">
                                            ...
                                            <div class="col-11 ml-3" >
                                                ...
                                                <div class="form-group row">
                                                 ...
                                                 <div class="form-group row">
                                                    ...
                                                    <div class="col-sm-7">
                                                        <input type="text" required class="form-control" value="" name="owner_name" style="border-radius: 25px">
                                                    </div>
                                                </div>
                                        ...
                                        <input type="submit" class="btn btn-success btn-rounded w-70  mb-2"  name="addVehicle" value="submit" style="margin-top: 15px;font-size: 21px; text-align: center;border: 1px solid;" >
                                ...
                                <div class="card-body" style="background-color: ">
                                    <div class="scroll-content">
                                        <table class="table" id="parvez1">
                                            ...
                                            <?php
                                            $lists=$datamanipulation->showVehicleData();
                                            $s=1;
                                            if($lists){
                                                foreach ($lists as $list){
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td>
                                                            ...
                                                            if($list->status=='yes'){
                                                                ?>
                                                                <span style="color: #00A000;font-size: 20px">Okay</span>
                                                                <?php
                                                            }else{
                                                                ?>
                                                        ...
                                                        <td class="text-center btn-group">
                                                            <a href="../staff/edit_add_vehicle.php?edit_vehicle_id=<?php echo $list->id?>" style="color: white" class="btn btn-group btn-rounded bg-success btn-outline-success attrValue show-chat-box-click" >  Edit</a>
                                                            <?php
                                                            if($list->status=='yes'){
                                                                ?>
                                                                <a href="../process/staff_process.php?vehicle_print_id=<?php echo $list->id?>" style="color: white" class="btn btn-danger btn-rounded btn-outline-dark attrValue show-chat-box-click" >  Printed</a>

                                                                <?php
                                                            }else{
                                                                ?>
                                                                <a href="../process/staff_process.php?vehicle_print_id=<?php echo $list->id?>" style="color: white" class="btn btn-group bg-primary btn-rounded btn-outline-dark attrValue show-chat-box-click" >  Print</a>
